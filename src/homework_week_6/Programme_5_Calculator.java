...
public class Programme_5_Calculator {
    ...
    public static void addition (int a , int b){
        ...
        System.out.println("The addtion of " + a + " and " + b + "is : " + result);
            }
    ...
    public void multiplicaiton(int a, int b)
    {
        ...
        System.out.println(" The multiplicaiton of"+ a + " and "+ b + "is :" +result);
    ...
    public static void main(String[] args) {
        ...
        obj.multiplicaiton(a,b);
        int divResult = obj.division(a,b);
        System.out.println("the division of " + a + "and "+ b + "is : " +sunResult );
